module"amisco_eu" {
  ...
  type = "MX"
  records = [
  "0 amisco-eu.mail.protection.outlook.com"
  ]
  },
  {
  name = ""
  ...
  type = "CNAME"
  records = [
  "dashboard.bench.prozone-it.com."
  ]
  },
  {
  name = "hub.bench"
  ...
  type = "CNAME"
  records = [
  "fr.matchcenter.pcache.amisco.eu."
  ]
  },
  {
  ...
  type = "CNAME"
  records = [
  "afs.matchcenter.pcache.amisco.eu."
  ]
  },
  {
  ...
  type = "ALIAS"
  alias {
  name = "ws.dev.fr.amisco.eu."
  zone_id = "module.r53_zone_ids.JJJJJ.euw1"
